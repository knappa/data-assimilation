...
from strat_ekf_wsg_plots import parameter_plots, state_plots
...
parser.add_argument("--sample_interval", help="interval between measurements", type=int, default=50)
...
) = np.abs(multivariate_normal(mean=mean_init_vec_spwp, cov=cov_matrix_init_spwp).rvs())
...
model_ensemble = model_ensemble_from(mean_init_vec_spwp, cov_matrix_init_spwp)
