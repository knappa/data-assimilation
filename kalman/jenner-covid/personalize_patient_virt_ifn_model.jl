...
virtual_pop_prior_mean = virtual_pop_prior_mean[[1, 2, 5, 6, 10]]
virtual_pop_prior_Σ = virtual_pop_prior_Σ[[1, 2, 5, 6, 10], [1, 2, 5, 6, 10]]
...
prior_Σs[2:state_space_dim, 2:state_space_dim, :] .=
    diagm((0.1 * initial_condition_state[2:state_space_dim]) .^ 2)
